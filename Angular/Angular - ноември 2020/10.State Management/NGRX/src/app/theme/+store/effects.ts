...
import { themeListLoadPostList, themeListLoadThemeList, themeListLoadThemeListError, themeListSetPostList, themeListSetThemeList } from './actions';
...
export class ThemeListEffects {
    ...
    loadThemeList$ = createEffect(() => this.actions$.pipe(
        ...
        map(result => result instanceof Error ?
            themeListLoadThemeListError({ error: result.message }) :
