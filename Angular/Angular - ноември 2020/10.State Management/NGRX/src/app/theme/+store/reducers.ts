...
export const initialThemeDetailState: IThemeDetailsState = {
    theme: null,
    isLoading: false
};

export const themeDetailReducer = createReducer<IThemeDetailsState>(
    ...
    on(themeListClear, () => initialThemeDetailState)
);
