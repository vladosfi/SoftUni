...
export const userProfileSetEditMode = createAction(`${userProfileNamespace} SET LOADING`, props<{ isEdit: boolean }>());
export const userProfileSetLoading = createAction(`${userProfileNamespace} SET EDIT MODE`, props<{ isLoading: boolean }>());
