namespace SystemTypeMethods
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            var ctors = personType.GetConstructors(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
            foreach (var ctor in ctors)
            {
                Console.WriteLine($"Constructor name: {ctor.DeclaringType.FullName}");
                var parameters = ctor.GetParameters();
                foreach (var parameter in parameters)
                {
                    Console.WriteLine($"Constructor {parameter.Name} is of type {parameter.ParameterType}");
                }
            }
