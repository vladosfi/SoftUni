namespace InstancesAndInvocations
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            //var secondInstance = Activator.CreateInstance<Person>();
            ...
            var nameValue = propertyName.GetValue(instance) as string;
            Console.WriteLine(nameValue);
            propertyName.SetValue(instance, "Ivaylo Kenov");
            nameValue = propertyName.GetValue(instance) as string;
            Console.WriteLine(nameValue);
        }
    }
}
